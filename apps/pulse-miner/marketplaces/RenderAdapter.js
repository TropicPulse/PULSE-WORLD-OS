// FILE: tropic-pulse-functions/apps/pulse-miner/marketplaces/RenderAdapter.js
//
...
//
// ROLE:
//   Render Network Marketplace Client Adapter — a lightweight ESM module
//   that defines how Tropic Pulse communicates with the Render Network GPU
//   rendering marketplace. Implements the standardized marketplace interface:
...
//     • It uses the RNDR* token for settlement between artists and GPU providers.
//     • Tropic Pulse does NOT interact with RNDR* — this adapter only reads
//       public job metadata and submits results. No wallets, no mining,
...
//     • A job normalizer (Render → Pulse format)
