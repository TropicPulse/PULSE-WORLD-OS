// FILE: tropic-pulse-functions/netlify/functions/alerts-system-miner-failure.js
//
...
//
// ROLE:
//   Netlify HTTP endpoint that receives system‑miner failure alerts
//   from the MinerEngine running on the frontend or system worker.
...
//   This endpoint is critical for system‑miner monitoring
...
export async function handler(event, context) {
  try {
    ...
    console.error("SYSTEM MINER FAILURE:", payload);
    ...
    console.error("miner failure alert error:", err);
    return {
      statusCode: 500,
      body: JSON.stringify({
        success: false,
