...
import { PulseProofBridgeLogger as logger, BridgeError as logError, BridgeLog as logInfo, BridgeWarn as logWarn } from "../../PULSEVISION/____BACKEND/PULSE-WORLD-BRIDGE.js";

import { admin, db } from "./PulseWorldGenome-v20.js";
import { twilio } from "./PulseWorldSMSAlert-v20.js";
import {
  getStripe,
...
<html>
                  ...
                  <tr>
                    <td align="center" style="padding-top:20px;">
                      ...
                      <a href="https://linktr.ee/tropicpulse" target="_blank">
                        <img src="../PULSEVISION/_PICTURES/SocialMedia.png"
  ...
  html: (payload) => {
    ...
    const trackingPixel =
      logId && logId !== "Preview Mode"
        ? `<img src="../PULSEVISION/_PICTURES/emailopen?logId=${encodeURIComponent(
            logId
          ...
          <div style="text-align:center; width:100%;">
            <div style="display:inline-block; text-align:center;">
              <div class="logo-circle" style="margin:0 auto 10px auto;">
                <img 
                  src="../PULSEVISION/_PICTURES/ToucanLogo-Mini.png"
                  alt="Tropic Pulse Toucan"
                  width="60"
