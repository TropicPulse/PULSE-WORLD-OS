// ============================================================================
// FILE: PulseMeshFlow-v30-IMMORTAL+++.js
// [pulse:mesh] COMMUNITY_FLOW_LAYER v30-IMMORTAL+++  // rainbow
...
// ============================================================================
//
// IDENTITY — THE FLOW ORGAN (v30-IMMORTAL+++):
// -------------------------------------------
...
// ============================================================================
// COMMUNITY FLOW LAYER — v30 IMMORTAL+++
// ============================================================================
    ...
    return {
      ...
      async run(impulse, entryNodeId, context = {}) {
        ...
        if (context.presenceTag) {
          ...
          impulse.flags.aura_presence_tag = "PulseFlow-v30";
        }

        // v30: mesh-tier + long-range + bluetooth presence as metadata-only flags
        ...
        try {
          ...
          // 3. CORTEX (strategic layer, echo-aware + mesh-tier + long-range)
          ...
          // -----------------------------------------------------------------
          if (echoMode) {
            log?.("[PulseFlow v30] Echo-mode run (diagnostic, read-only)", {
              entryNodeId,
              band: impulse.band,
              presenceTag: impulse.flags.aura_presence_tag,
              meshTier,
          ...
          warn?.("[PulseFlow v30] Flow error", { error: String(err) });
