...
// ============================================================================
//  ORGAN IMPLEMENTATION — v30 IMMORTAL-CORE++ Membrane
// ============================================================================
export class AIBinaryPageScannerAdapter {
  constructor(config = {}) {
    ...
    // optional mesh context (read-only)
    this.meshId = config.meshId || null;
    ...
    // Window configuration for artery v5
    this.windowMs =
...
// ---------------------------------------------------------------------------
  ...
  _trace(event, payload) {
    ...
    console.log(
      `[${this.id}#${this.instanceIndex}@${PageScannerAdapterMeta.version}] ${event}`,
      payload
    );
  }
}
