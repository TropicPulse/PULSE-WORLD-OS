  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    function getSignalSnapshot() {
      try {
        ...
        if (globalThis.PulseSignal && typeof globalThis.PulseSignal.getState === "function") {
          const state = globalThis.PulseSignal.getState();
          if (state) return state;
        }

        // Fallback: PulseProofSignal.latest (merged top-layer)
        if (globalThis.PulseProofSignal && typeof globalThis.PulseProofSignal.latest === "function") {
          const latest = globalThis.PulseProofSignal.latest();
    ...
    try {
      ...
      if (globalThis.BinaryOS && typeof globalThis.BinaryOS.boot === "function") {
        globalThis.BinaryOS.boot();
        logOK("BinaryOS booted");
      }

      if (globalThis.DualBandAI && typeof globalThis.DualBandAI.boot === "function") {
        globalThis.DualBandAI.boot();
