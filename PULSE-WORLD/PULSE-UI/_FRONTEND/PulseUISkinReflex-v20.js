...
AI_EXPERIENCE_META = {
  ...
  lineage: "PulseSkinReflex-v12-Evo-BINARY-MAX → v14-Immortal → v16-Immortal-Evo → v20-Immortal",
...
const AI_EXPERIENCE_META = {
  ...
  role: "a1_surface_reflex + a3_error_spine",
  lineage:
    "PulseSkinReflex-v12-Evo-BINARY-MAX → v14-Immortal → v16-Immortal-Evo → v20-Immortal",
  ...
  contract: {
    always: [
      ...
      "PulseUI.RouteMemory",
      "PulseUIErrors",
      "PulseProofBridge.safeRouteV20",
      "PulseProofBridge.safeRoute"
    ],
    never: ["eval", "Function", "dynamicImport"]
  }
};
