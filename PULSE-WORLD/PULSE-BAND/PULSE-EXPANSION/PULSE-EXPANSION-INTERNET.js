...
buildExpansionPlan({
  ...
  // ========================================================================
  // EMIT INTENTS TO PULSE-NET BRIDGE — v24
  // ========================================================================
  ...
  const rawPlan = new ExpansionPlan({
    ...
    // ========================================================================
    // LOG + RETURN FINAL FEDERALLY-AWARE, EVOLVED EXPANSION PLAN — v24
    // ========================================================================
    logger?.log?.("expansion", "plan_built_v24_federal", {
      cycle: this.cycle,
