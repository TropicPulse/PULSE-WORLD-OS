...
//   • No randomness
//   • No mutation of external systems (beyond Router/route calls)
...
// optional advantage hint: window.PULSE_ADVANTAGE_SCORE ∈ [0,1]
...
// ----------------------------------------------------------------------
      ...
      try {
        if (typeof Router !== "undefined" && Router && typeof Router.receiveReflex === "function") {
