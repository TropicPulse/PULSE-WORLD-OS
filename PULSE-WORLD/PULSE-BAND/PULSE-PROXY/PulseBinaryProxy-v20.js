...
AI_EXPERIENCE_META = {
  ...
  lineage: "BinaryOrganism-v20-Immortal",
  ...
  evo: {
    ...
    // v16+ cache/chunk/presence/prewarm/advantage
    ...
    // v20++ resource + impulse + router memory + PNS awareness
  ...
  contract: {
    ...
    output: [
      ...
      "BinaryResourceEnvelope",
      "BinaryImpulseEnvelope",
      "BinaryRouterMemoryEnvelope",
      "BinaryPnsEnvelope",
...
const BinaryProxyRole = Object.freeze({
  ...
  lineage: {
    ...
    pns: "PulseProxyPNSNervousSystem-v20",
    synapse: "PulseProxySynapse-v20",
    limbic: PULSE_LIMBIC_SHADOW_META?.identity || "LimbicShadow",
    client: "PulseClient",
    net: "PulseNet",
    worldBridge: "PulseWorldBridge"
  },
...
export const PulseOSBinaryProxyMeta = Object.freeze({
  ...
  role: "PURE_BINARY_NERVE_ROOT",
  version: "v20.4-Immortal-ABA-ADVANTAGE-PRESENCE-PLUS",
  identity: "BinaryProxy-v20.4-Immortal-ABA-ADVANTAGE-PRESENCE-PLUS",
  ...
  guarantees: Object.freeze({
    ...
    // v20++ resource / impulse / router memory / PNS
    resourcePressureAware: true,
    impulseSpeedAware: true,
    routerMemoryAware: true,
    pnsAware: true,
    nervousSystemAware: true,
    routerMemoryEnvelopeEmitter: true,
    pnsEnvelopeEmitter: true,
    resourceEnvelopeEmitter: true,
    impulseEnvelopeEmitter: true,
  ...
  lineage: Object.freeze({
    ...
    parent: "BinaryOrganism-v20-Immortal",
    ancestry: [
      "BinaryProxy-v9",
      "BinaryProxy-v10",
      "BinaryProxy-v11",
      ...
      "BinaryProxy-v16-Immortal-ABA-ADVANTAGE",
      "BinaryProxy-v20-Immortal-ABA-ADVANTAGE"
    ]
  }),
  ...
  architecture: Object.freeze({
    ...
    adaptive:
      "ABA band signatures + cacheChunk/presence/prewarm/advantage/resource/impulse/PNS/routerMemory envelopes",
    return:
      "pure binary nerve output + signatures + deterministic envelopes + healing state"
  })
});
