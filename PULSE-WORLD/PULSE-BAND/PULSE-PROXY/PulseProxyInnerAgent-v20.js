...
// ============================================================================
/*
@PULSE_IMMORTAL_REQUIRE_FULL_META_20XX
This organ requires FULL IMMORTAL20++ metadata on every upgrade:
- AI_EXPERIENCE_META + AI_EXPERIENCE_CONTEXT
- Full organ metadata + evo flags + lineage
- Full contract (input/output/consumers)
- Full experience surfaces (band/wave/binary/presence/advantage/speed/experience)
- Full IMMORTAL++ overlays (drift, pressure, stability, load, healing)
- Full chunk/cache/prewarm overlays (bridge‑level + route‑level)
- Full world‑lens, limbic, tri‑heart, impulse‑speed‑policy awareness
- Full healing surfaces + diagnostics + bridge‑health
Always include ALL layers, ALL overlays, ALL IMMORTAL20++ structures.
*/

import { corsHandler, pulseCors } from "../PULSE-X/PulseWorldTransport-v20.js";

// ============================================================================
//  ORGAN IDENTITY — v20‑IMMORTAL‑BRIDGE
// ============================================================================
export const PulseRole = {
  type: "Organ",
  subsystem: "PulseProxy",
  layer: "InnerAgent",
  version: "20-Immortal-Bridge",
  identity: "PulseProxyInnerAgent-v20-Immortal-Bridge",
...
export const AI_EXPERIENCE_META = Object.freeze({
  ...
  version: "v20-Immortal-Bridge",
  layer: "inner_agent",
  role: "organism_bridge_dual_band",
  lineage: Object.freeze({
    root: "PulseProxy-v16",
    parent: "PulseProxyInnerAgent-v16.3-Immortal-Bridge",
  ...
  contract: Object.freeze({
    ...
    output: [
      ...
      "InnerAgentSpeedPolicy",
      "InnerAgentPresenceView",
      "InnerAgentChunks",
  ...
  experience: Object.freeze({
    description:
      "The v20 Immortal Inner Agent is the organism bridge between CNS, Router, " +
      "ProxySpine, OuterAgent, Brain, LongTermMemory, and Pages. It never fetches " +
      "internet directly; it beams impulses upward to Expansion/OuterAgent and " +
      "receives negotiated results back, while maintaining dual-band, presence, " +
      "advantage, speed, experience, and bridge‑health fields for every dispatch.",
    aiUsageHint:
      "Use InnerAgentSpeedField, InnerAgentAdvantageField, InnerAgentExperienceField, " +
      "InnerAgentSpeedPolicy, and InnerAgentPresenceView to reason about how quickly " +
      "impulses are dispatched inward, how much advantage is propagated from " +
      "ProxySpine/OuterAgent, how loaded the bridge is across Brain/LTM/Pages routes, " +
      "and how stable the bridge is over time."
  })
});
...
export const PulseProxyInnerAgentMeta = Object.freeze({
  ...
  lineage: Object.freeze({
    ...
    ancestry: [
      ...
      "PulseProxyInnerAgent-v20-Immortal-Bridge"
    ]
  }),
  ...
  architecture: Object.freeze({
    ...
    adaptive:
      ...
      "+ fail-open surfaces + bridge‑chunk/presence overlays",
    return:
      "deterministic dispatch surfaces + signatures + speed/advantage/experience/policy fields " +
      "+ bridge‑presence view + chunked dispatch history"
  })
});
