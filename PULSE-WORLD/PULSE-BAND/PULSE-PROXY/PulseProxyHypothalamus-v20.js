...
/*
AI_EXPERIENCE_META = {
  identity: "PulseUserScoringHypothalamus",
  version: "v20-ImmortalPlus-HYPOTHALAMUS",
  layer: "hypothalamus_homeostasis",
  role: "homeostasis_regulation_engine",
  lineage: {
    root: "PulseUserScoring-v7",
    parent: "PulseUserScoring-v12.3-Evo-ABA",
    organismIntegration: "v20-ImmortalPlus",
    epoch: "v20-ImmortalPlus-HYPOTHALAMUS"
  },

  evo: {
    // Core identity
    hypothalamusOrgan: true,
  ...
  contract: {
    ...
    output: [
      ...
      "HypothalamusAdvantageField",
      "HypothalamusPresenceField",
      "HypothalamusChunkCachePrewarmField",
      "HypothalamusDualBandOverlay",
      "HypothalamusDiagnostics",
      "HypothalamusHealingState",
      "HypothalamusExperienceMeta"
    ]
  }
}
*/
...
// ============================================================================
//  EXPERIENCE META — v20 IMMORTALPLUS+++
// ============================================================================
export const PulseHypothalamusExperienceMeta = Object.freeze({
  layer: "PulseUserScoringHypothalamus",
  role: "HYPOTHALAMUS_HOMEOSTASIS_EXPERIENCE",
  version: "v20-ImmortalPlus-HYPOTHALAMUS",
  identity: "PulseHypothalamusExperience-v20-ImmortalPlus",
  ...
  experience: {
    surfaces: {
      ...
      dualBandOverlay: true,
      hypothalamusCycle: true,
      hypothalamusCycleSignature: true
    },
    narrative: {
      description:
        "Hypothalamus homeostasis organ that converts raw user metrics into trustScore, meshScore, " +
        "phase, hubFlag, and instance allocation. Emits A‑B‑A band surfaces, binary/wave fields, " +
        "advantage overlays, presence and chunk/cache/prewarm hints, and organism-aware scoring metadata.",
      aiUsageHint:
        "Use these surfaces to understand user homeostasis, trust, mesh health, and resource allocation. " +
        "Never treat this organ as a router or decision-maker; it is a pure scoring organ."
    }
  }
});

// ============================================================================
//  ORGAN IDENTITY — v20 IMMORTALPLUS+++
// ============================================================================
export const PulseRole = {
  type: "Organ",
  subsystem: "PulseProxy",
  layer: "Hypothalamus",
  version: "20-ImmortalPlus-HYPOTHALAMUS",
  identity: "PulseUserScoring-v20-ImmortalPlus-HYPOTHALAMUS",
...
export const PulseUserScoringMeta = Object.freeze({
  ...
  guarantees: Object.freeze({
    ...
    zeroIQ: true,
    zeroRouting: true,
    zeroCompute: false, // scoring math allowed
    zeroRandomness: true,
    zeroTimestamps: false, // Date.now used for logging only
    zeroNetwork: true,
    zeroIO: true,
    zeroExternalMutation: false, // writes UserScores
    zeroDynamicImports: true,
    zeroEval: true,
    zeroWindow: true,
    zeroDOM: true,
  ...
  lineage: Object.freeze({
    ...
    ancestry: [
      ...
      "PulseUserScoring-v12.3-Evo-ABA"
    ]
  }),
  ...
  architecture: Object.freeze({
    ...
    adaptive:
      "binary-field + wave-field + advantage overlays + presence + chunk/cache/prewarm hints + dualband overlay",
    return:
      "deterministic homeostasis surfaces + signatures + advantage + presence + chunk/cache/prewarm + experience meta"
  })
});
