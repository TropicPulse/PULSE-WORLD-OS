...
AI_EXPERIENCE_META = {
  ...
  version: "v20-Immortal-CHUNK",
  layer: "impulse_engine",
  role: "neural_impulse_lifecycle",
  lineage: {
    root: "PulseOS-v11",
    parent: "PulseOSImpulseEngine-v16-Immortal-CHUNK",
  ...
  evo: {
    ...
    limbicAware: true,
    triHeartAware: true,
    organismPressureAware: true,
    organismStabilityAware: true,
    healingOverlayAware: true,
    driftOverlayAware: true,
    loadOverlayAware: true,
  ...
  contract: {
    input: [
      ...
      "PresenceContext",
      "SpeedProfile",
      "OrganismPressureContext",
      "OrganismStabilityContext",
      "WorldLensContext"
    ],
    output: [
      "BinaryImpulse",
      ...
      "ImpulsePressureField",
      "ImpulseStabilityField",
      "ImpulseWorldLensField",
      "ImpulseDiagnostics",
      "ImpulseHealingState",
      "ImpulseChunks",
  ...
  experience: {
    description:
      "The v20 Immortal Impulse Engine manages the full lifecycle of neural impulses, " +
      "including band/wave/binary/presence fields, chunked views, prewarm snapshots, " +
      "speed-aware dynamics, and organism-level pressure/stability/world-lens overlays.",
    aiUsageHint:
      "Use ImpulseSpeedField, ImpulseAdvantageField, ImpulseExperienceField, ImpulsePressureField, " +
      "ImpulseStabilityField, and ImpulseWorldLensField to reason about how impulses move, how much " +
      "advantage they generate, how loaded the organism is, and how stable routes are across the organism."
  }
};
*/
...
// ============================================================================
// CONTEXT / META — v20 IMMORTAL CHUNK
// ============================================================================
const IMPULSE_CONTEXT = {
  version: "20-Immortal-CHUNK",
  layer: "ImpulseEngine",
...
export const AI_EXPERIENCE_META = Object.freeze({
  ...
  experience: Object.freeze({
    ...
    aiUsageHint:
      "Use ImpulseSpeedField, ImpulseAdvantageField, ImpulseExperienceField, ImpulsePressureField, " +
      "ImpulseStabilityField, and ImpulseWorldLensField to reason about how impulses propagate, " +
      "how much advantage they generate, how loaded the organism is, and how stable routes are."
  })
});
...
export const PulseOSImpulseEngineMeta = Object.freeze({
  ...
  version: "v20-Immortal-CHUNK",
  identity: "PulseOSImpulseEngine-v20-Immortal-CHUNK",
  ...
  lineage: Object.freeze({
    ...
    ancestry: [
      ...
      "PulseOSImpulseEngine-v20-Immortal-CHUNK"
    ]
  }),
  ...
  architecture: Object.freeze({
    ...
    adaptive:
      "dual-band + presence overlays + chunked impulse views + speed-aware + pressure/stability/world-lens dynamics",
    return:
      "deterministic impulse surfaces + signatures + coreMemory + chunk/presence/speed/pressure/stability/world-lens"
  })
});
